                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                <div className="group flex items-center gap-6 p-6 rounded-none border border-white/10 bg-white/5 hover:bg-white/10 hover:shadow-lg transition-all duration-300">
                                    <div className="w-14 h-14 rounded-none flex items-center justify-center text-accent-primary bg-accent-primary/10 group-hover:scale-110 transition-transform duration-500">
                                ...
                                <div className="group flex items-center gap-6 p-6 rounded-none border border-white/10 bg-white/5 hover:bg-white/10 hover:shadow-lg transition-all duration-300">
                                    <div className="w-14 h-14 rounded-none flex items-center justify-center text-accent-secondary bg-accent-secondary/10 group-hover:scale-110 transition-transform duration-500">
                            ...
                            <div className="flex gap-4 pt-4">
                                <motion.a 
                                    ...
                                    className="w-12 h-12 rounded-none cyber-panel rounded-none flex items-center justify-center hover:bg-accent-primary hover:text-black transition-all"
                                >
                                ...
                                <motion.a 
                                    ...
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    className="w-12 h-12 rounded-none cyber-panel rounded-none flex items-center justify-center hover:bg-accent-secondary hover:text-black transition-all"
                                >
                        ...
                        <motion.div 
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            className="relative bg-white/5 p-8 md:p-12 overflow-hidden border border-white/10 rounded-none shadow-2xl"
                        >
                                ...
                                {isSubmitted ? (
                                    ...
                                    >
                                        ...
                                        <motion.button
                                            ...
                                            className="px-10 py-4 rounded-none border border-accent-primary/20 text-accent-primary font-bold uppercase tracking-widest text-xs hover:bg-accent-primary hover:text-black transition-all"
                                        >
                                            Send Another
                                        </motion.button>
                                    </motion.div>
                                    ...
                                    >
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="relative group">
                                                    <input
                                                        ...
                                                        className="w-full bg-white/5 border border-white/5 px-6 py-4 rounded-none focus:outline-none focus:border-accent-primary/50 focus:ring-4 focus:ring-accent-primary/10 transition-all text-base text-foreground placeholder-white/20 cyber-panel rounded-none"
                                                        required
                                                    />
                                                </div>
                                            </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="relative">
                                                <select name="subject" className="w-full bg-white/5 border border-white/5 px-6 py-4 rounded-none focus:outline-none focus:border-accent-primary/50 focus:ring-4 focus:ring-accent-primary/10 transition-all appearance-none cursor-pointer text-base text-foreground/80 cyber-panel rounded-none">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full bg-white/5 border border-white/5 px-6 py-4 rounded-none focus:outline-none focus:border-accent-primary/50 focus:ring-4 focus:ring-accent-primary/10 transition-all text-base text-foreground placeholder-white/20 resize-none cyber-panel rounded-none"
                                                required
                                            ></textarea>
                                        </div>
                                        <motion.button
