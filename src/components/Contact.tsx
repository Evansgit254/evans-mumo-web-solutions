                        ...
                        >
                            ...
                            <div className="flex gap-4 pt-4">
                                <motion.a 
                                    ...
                                    className="w-12 h-12 rounded-2xl glass-morphism flex items-center justify-center hover:bg-accent-primary hover:text-black transition-all"
                                >
                                ...
                                <motion.a 
                                    ...
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    className="w-12 h-12 rounded-2xl glass-morphism flex items-center justify-center hover:bg-accent-secondary hover:text-black transition-all"
                                >
                                    ...
                                    >
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="relative group">
                                                    <input
                                                        ...
                                                        className="w-full bg-white/5 border border-white/5 px-6 py-4 rounded-2xl focus:outline-none focus:border-accent-primary/50 focus:ring-4 focus:ring-accent-primary/10 transition-all text-base text-foreground placeholder-white/20 glass-morphism"
                                                        required
                                                    />
                                                </div>
                                            </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="relative">
                                                <select name="subject" className="w-full bg-white/5 border border-white/5 px-6 py-4 rounded-2xl focus:outline-none focus:border-accent-primary/50 focus:ring-4 focus:ring-accent-primary/10 transition-all appearance-none cursor-pointer text-base text-foreground/80 glass-morphism">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full bg-white/5 border border-white/5 px-6 py-4 rounded-2xl focus:outline-none focus:border-accent-primary/50 focus:ring-4 focus:ring-accent-primary/10 transition-all text-base text-foreground placeholder-white/20 resize-none glass-morphism"
                                                required
                                            ></textarea>
                                        </div>
                                        <motion.button
